...
#
#
# March 9, 2019 SG Added Microsoft Azure IoT Hub send event
...
PRESSURE = 972.0
HUMIDITY = 60
MSG_TXT = "{\"temperature\": %.2f,\"pressure\": %.2f,\"humidity\": %.2f}"
...
if __name__ == '__main__':
    print ( "Sending messages to Microsoft Azure IoT Hub" )
